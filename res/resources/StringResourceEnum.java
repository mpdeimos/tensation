...
public interface StringResourceEnum
{
	...
	public static class StringResourceEnumResolver
	{
		...
		/* package */static String string(StringResourceEnum stringEnum)
		{
			...
			if (resourceBundle == null)
			{
				...
				{
					Log.e(StringResourceEnum.class, e.getMessage());
					return NOT_FOUND;
				}
			}
			...
			finally
			{
				if (str == null)
				{
					Log.w(StringResourceEnum.class, "String not found: " + name); //$NON-NLS-1$
					str = NOT_FOUND;
				}
			}
			return str;
